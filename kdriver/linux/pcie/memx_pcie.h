...
#define MEMX_POLLING_ADDR_START (0x1FC000)
#define MEMX_POLLING_BUFFER_PAGE_SIZE (0x1000)
#define MEMX_GET_POLLING_ADDR(memx_dev, offset) (((memx_dev)->mpu_data.rx_dma_coherent_buffer_virtual_base) + \
												MEMX_POLLING_ADDR_START + (offset) * POLLING_ADDR_BYTE_OFFSET)
#define EGR_MSIX_VECTOR_OFFS(id) (1+(id)*2)
#define IGR_MSIX_VECTOR_OFFS(id) (((id)+1)*2)
#define HOST_CMD_DONE_ACK_ID     (0)
#define POLLING_ADDR_BYTE_OFFSET (64)
